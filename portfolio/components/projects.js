...
export default function Projects() {
  ...
  function changeProject(id, direction) {
    i = id + direction;
    setProject(ProjectCardsList[i])
    MenuActive(i)
  }

  function SelectProject(keyProject){
    document.getElementById("ScrollContainer").scrollTo({top: 4265 + 6*265*(keyProject), behavior: "smooth"});
  }
  ...
  let IDImageLeftProjects = "IDImageLeftProjects";
    ...
    useEffect(() => {
      ...
      document.getElementById("ProjectsTrigger").addEventListener('wheel', function(event) {document.getElementById("ScrollContainer").scrollBy(0, event.deltaY);});
      ...
      //GSAP
        let ctx = gsap.context(() => {
          ...
          .from(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:0, duration : 1}, 0)
          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:0, duration : 1}, 5)
          .call(() => {changeProject(i, direction)})

          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:1, duration : 1}, 6)
          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:0, duration : 1}, 11)
          .call(() => {changeProject(i, direction)})

          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:1, duration : 1}, 12)
          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:0, duration : 1}, 17)
          .call(() => {changeProject(i, direction)})

          .to(["#"+IDDescriptionProjects, "#projectTitle", "#"+IDImageDownProjects, "#"+IDImageLeftProjects, "#"+IDImageUpProjects], {opacity:1, duration : 1}, 18) 
        });
          return () => ctx.revert();
      }, []);
...
{/* <Image src={project.image} alt="Galactisen" fill style={{objectFit:"contain"}}/> */}
